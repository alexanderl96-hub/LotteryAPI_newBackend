...
-- INSERT INTO mega_millions (date, one, two, three, four, five, mega_millions_lucky, megaplier, amount, image ) VALUES 
...
-- INSERT INTO take_5_Day (date, one, two, three, four, five, amount, image, timedate ) VALUES 
--    ('01/28/2023', 5, 6, 19, 31, 33, 50000, 'Icons/Take_5.png', '10:25 am');  
...
-- INSERT INTO win_4_Day (date, one, two, three, four, amount, image, timedate ) VALUES 
--    ('01/28/2023', 7, 8, 9, 7, 5000, 'Icons/Win_4.png', '10:25 am'); 

-- INSERT INTO win_4_Night (date, one, two, three, four, amount, image ) VALUES 
--    ('01/28/2023', 9, 2, 9, 1, 5000, 'Icons/Win_4.png'); 

-- INSERT INTO numbers_Day (date, one, two, three, amount, image, timedate ) VALUES 
--    ('01/27/2023', 1, 6, 6, 500, 'Icons/Numbers_logo.png', '10:25 am'); 
...
--    ('11/03/2023', 'alexanderl96872', 'alexander2.lrperez@gmail.com', 'Echu3Nigue872', 'Icons/admission.png'); 
