...
//             String trimm = line.trim();

//             content = content.replaceAll("ApiOperation* everything inside","")
//             String valueresponse = "defautl";

//             java.util.regex.Matcher matcher = java.util.regex.Pattern.compile("i want to grab the value of value").matcher(content);

//             while(matcher.find()){
//                 valueresponse = matcher.group(1)
//             }


//             if(trimm.startsWith("@ApiResponses")){
//                 content = content.replaceAll("@ApiResponses* everything inside",
//                                             "@Operation(summary = " + valueresponse + ", description = \"Provide\", responses ={$1} )")
...
//         return  valueMatcher.find() ? valueMatcher.group(1) : "default_summary";  // Return a default value if "value" is not found
//     }
// }

// @ApiOperation( value="the value that i want to get",  httpMethod= "Get", cosumes = "somevalue", produces = "somevalue")